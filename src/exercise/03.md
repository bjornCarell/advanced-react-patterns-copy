...
By creating flexible compound components, with the help of the context API, we
can pass the state to any component within our Provider. No matter if that
component is a child, grand child, or great grand child.
